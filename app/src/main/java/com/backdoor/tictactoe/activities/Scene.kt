...
import com.backdoor.tictactoe.databinding.ActivitySceneBinding
import com.backdoor.tictactoe.models.DatabaseHelper
import com.backdoor.tictactoe.models.GameMoves
import com.backdoor.tictactoe.ticTacToe.TicTacToeDataListener
...
class Scene : AppCompatActivity(), TicTacToeDataListener {
    ...
    private fun addItemToHistoryList(name: String, position: String) {
        historyList.add(0, HistoryModal(name, position))
    ...
    private fun setStartingFields() {
        ...
        mBinding.sceneScoreBoard.playerTwoName =
    ...
    override fun updateGameOverState(isGameOver: Boolean, winnerSideOrDraw: String) {
        ...
        when (winnerSideOrDraw) {
            getString(R.string.draw) -> {
                ...
                addItemToHistoryList("Game Draw", "-")
            }
            getString(R.string.first_player) -> {
                mBinding.gameOverBoard.winnersName = "${
            ...
            getString(R.string.second_player) -> {
                ...
                var playerPosition = mSharedPreference.getValue(
                    String::class.java,
                    Constants.KEY_PLAYER_1_SIDE,
                    Constants.VALUE_PLAYER_1_SIDE_X
                )

                if (playerPosition == Constants.VALUE_PLAYER_1_SIDE_X) {
                    playerPosition = Constants.VALUE_PLAYER_1_SIDE_O
                } else if (playerPosition == Constants.VALUE_PLAYER_1_SIDE_O) {
                    playerPosition = Constants.VALUE_PLAYER_1_SIDE_X
                }
